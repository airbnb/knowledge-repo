...
# This is a Knowledge Repo Test Post

_NOTE: template comments will be in italics_

_NOTE: for the title, optimize for **specificity**. Avoid high level concept
style titles like "Instant Book Supply and Demand"._ Instead, title around
either:

- _The takeaway from the entire post, at the exact level of specificity and
  granularity of the point the post shows, ie. 'Last Minute Cities by Overall SDI
  Index'_
- _The question the blog is answering, with the takeaway immediately after, ie.
...
_NOTE: In the TL,DR, optimize for **clarity** and **comprehensiveness**. The
...
_NOTE: optimize in this section for **context setting**, as specifically as you
...
while being able to painlessly aggregate it later._
...
_NOTE: in graphs, optimize for being able to **stand alone**. As we aggregate
