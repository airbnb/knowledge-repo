...
from knowledge_repo.app.models import Comment, Post
...
class CommentTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with self.repo_app.app_context():
            self.user_id = check_user_exists(self.knowledge_username).id
    ...
    def test01_comment_on_a_post(self):
        ...
        with self.repo_app.app_context():
            ...
            rv = self.app.post('/comment?post_id={}'.format(post.path),
            ...
            # TODO fix frontend routes to always reference post id, not post path
    ...
    def test02_delete_a_comment(self):
        ...
        with self.repo_app.app_context():
            ...
            rv = self.app.get('/delete_comment?comment_id=' + str(comment_id),
                              headers=self.headers)
            assert rv.status == '200 OK'
